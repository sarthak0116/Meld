    ...
    <>
      <header className="col-span-full flex items-center justify-between border-b border-[#0b0c0b]/20 pb-4 z-20">
        ...
        <nav className="hidden gap-10 md:flex">
          {NAV_ITEMS.map((item) => (
            <a key={item} href="#" className="group relative font-['Rajdhani'] text-[13px] font-bold tracking-[3px] text-[#0b0c0b] no-underline">
      ...
      >
        <div className="flex flex-col gap-1 px-4 py-4">
          {NAV_ITEMS.map(item => (
            <a key={item} href="#" onClick={() => setMenuOpen(false)} className="font-['Rajdhani'] text-[13px] font-bold tracking-[3px] text-[#0b0c0b]/70 py-2 no-underline hover:text-[#0b0c0b]">
